...
- **UI_AUTOMATION.md**: Rewritten to document the working osascript + screencapture + Swift approach for interactive UI exploration; removed speculative tool catalog
